...
SRC_URI="http://isabelle.in.tum.de/dist/${MY_P}.tar.gz
		http://isabelle.in.tum.de/components/${CSDP_IC_P}.tar.gz
		http://isabelle.in.tum.de/components/${EXEC_PROCESS_IC_P}.tar.gz
		...
		http://isabelle.in.tum.de/components/${POLYML_P}.tar.gz
		http://isabelle.in.tum.de/components/${XZ_JAVA_P}.tar.gz"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-2016-classpath.patch"
	...
	epatch "${FILESDIR}/${PN}-2016-libsha1.patch"
